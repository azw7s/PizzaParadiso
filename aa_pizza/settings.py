...
# AWS
AAKI = os.environ.get('AWS_ACCESS_KEY_ID')
AWS_ACCESS_KEY_ID = AAKI
ASAK = os.environ.get('AWS_SECRET_ACCESS_KEY')
AWS_SECRET_ACCESS_KEY = ASAK
ASBN = os.environ.get('AWS_STORAGE_BUCKET_NAME')
AWS_STORAGE_BUCKET_NAME = ASBN
ASFO = os.environ.get('AWS_S3_FILE_OVERWRITE')
AWS_S3_FILE_OVERWRITE = ASFO
ADA = os.environ.get('AWS_DEFAULT_ACL', None)
AWS_DEFAULT_ACL = ADA
