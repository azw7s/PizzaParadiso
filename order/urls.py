...
urlpatterns = [
    ...
    # Cart
    path('cart/<uuid:cart_uuid>/', views.CartDetail.as_view(), name='cart_detail'),
    ...
    path('create_checkout_session/<uuid:cart_uuid>/', views.CreateCheckoutSession.as_view(),
    ...
    path('order/history/<uuid:customer_uuid>/', views.OrderList.as_view(), name='order_list'),
    path('order_delivered/update/', views.order_delivered_update, name='order_delivered_update'),

    # Staff
    path('staff/orders/<uuid:staff_uuid>/', views.OrderStaff.as_view(), name='order_staff'),
